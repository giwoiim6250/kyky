			...
			<div class="dealer-edit-cont-info">
				<form method="post" target="_self" accept-charset="UTF-8" action="/buying/save.htm" id="js_form">
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
						...
						<tr>
							<td class="edit-title">经销商</td>
							<td class="edit-cont" id="js_select_store">
								<select name="store1" class="select-province prov" id="js_province" mr="选择区">
									<option value="0">选择区</option>
								</select>
								<select name="store2" class="select-city city" id="js_city" mr="选择省">
									<option value="0">选择省</option>
								</select>
								<select name="storeAddress" class="select-4S dist" id="js_4S" mr="选择经销商">
						...
						<tr>
							<td class="edit-title">业务员姓名</td>
							<td class="edit-cont">
								<input type="text" name="businessUsername" class="input-salesname" value="" id="js_salesname"/>
							</td>
							<td class="edit-alert">
								<div class="tip-error">
									填写错误
						...
						<tr>
							<td class="edit-title">业务员电话</td>
							<td class="edit-cont">
								<input type="text" name="businesseTelephone" class="input-salestel" value="" id="js_salestel" maxlength="11"/>
							</td>
							<td class="edit-alert">
								<div class="tip-error">
									填写错误
